...
export interface MockPassesInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "balanceOf"
      | "buyPasses"
...
export interface MockPasses extends BaseContract {
  connect(runner?: ContractRunner | null): MockPasses;
  waitForDeployment(): Promise<this>;

  interface: MockPassesInterface;
  ...
  ): TypedContractMethod<[_vaultFactory: AddressLike], [void], "nonpayable">;
  getFunction(
